...
export default function App() {
  ...
  // Effetto per gestire lo sfondo e resettare i vincoli di larghezza predefiniti di Vite
  useEffect(() => {
    const activeTheme = THEMES.find(t => t.id === theme) || THEMES[0];
    
    // Forziamo il body a prendere tutto lo schermo senza margini esterni insoliti
    ...
    // Elimina le restrizioni di max-width che Vite applica di default su #root
  ...
  return (
    <div style={{ 
      ...
      alignItems: 'center' // Centra orizzontalmente tutto il contenuto dell'app sullo schermo
    }}>
      ...
      {/* CONTENITORE PRINCIPALE DI LARGHEZZA MASSIMA MA BEN CENTRATO */}
      <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        {viewMode === 'daily' ? (
          /* =================== VISTA GIORNALIERA CORRETTA =================== */
          <div style={{ display: 'grid', gridTemplateColumns: '340px 1.3fr 1fr', gap: '30px', alignItems: 'start', width: '100%' }}>
